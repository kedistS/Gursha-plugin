...
class Lounge_Managment {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Lounge_Managment_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name = 'lounge-managment';
	 ...
	 *
	 * - Lounge_Managment_Loader. Orchestrates the hooks of the plugin.
	 * - Lounge_Managment_i18n. Defines internationalization functionality.
	 * - Lounge_Managment_Admin. Defines all hooks for the admin area.
	 * - Lounge_Managment_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Lounge_Managment_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
