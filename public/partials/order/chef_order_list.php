    ...
    if (is_array($user_orders)) {
        ...
        <table>
            ...
            foreach ($user_orders as $order) { ?>
                <tbody>
                    <td>
                        <?php echo $order_user_data->user_login ?>
                    </td>
                    <td>
                        <?php echo isset($order['bill_id']) ? $order['bill_id'] : '' ?>
                    </td>
                    <td>
                        <?php echo $order['food_item'] ?>
                    </td>
                    <td>
                        <?php echo $order['food_quantity'] ?>
                    </td>
                    <td>
                        <?php echo human_time_diff($order['ordered_at']) . ' ago.' ?>
                    </td>
                    ...
                    <td>
                        <button class="gursha-submit-status" data-user-id="<?php echo $user_id ?>"
                            data-bill-id="<?php echo isset($order['bill_id']) ? $order['bill_id'] : '' ?>">Submit</button>
                    </td>
